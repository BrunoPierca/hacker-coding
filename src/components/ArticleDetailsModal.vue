        ...
        <v-dialog v-model="dialog" max-width="600px" @click:outside="handleCloseModal">
            <v-card>
                ...
                <v-card-text>
                    ...
                    <v-container>
                        ...
                        <v-row>
                            ...
                            <v-col cols="12">
                                {{ item.comment_text ? cleanInput(item.comment_text) : "No comment"}}
                            </v-col>
                ...
                <v-card-actions>
                    ...
                    <v-btn color="primary" :disabled="!item.story_url" :href="item.story_url" target="_blank" @click="handleCloseModal">
                        Take me there...
                    </v-btn>
